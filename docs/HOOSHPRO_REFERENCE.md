...
- [x] V6 inspector/style pass (phase 1.9): added layout knobs for `rowGap`, `columnGap`, `flexDirection`, `flexWrap`, `justifyContent`, and `alignItems` in the visual style panel
